...
function Dashboard() {
    return (
        <>
            <div className="min-h-[calc(100vh-70px)] w-full p-5">
                <div className="p-10 h-full border border-red-100">
                    <div className="flex flex-wrap gap-4 w-full justify-center border border-red-300">
                        <div className="basis-56 h-12 shrink-0 bg-red-100">1</div>
                        <div className="basis-56 h-12 shrink-0 bg-red-100">1</div>
                        <div className="basis-56 h-12 shrink-0 bg-red-100">1</div>
                        <div className="basis-56 h-12 shrink-0 bg-red-100">1</div>
                        <div className="basis-56 h-12 shrink-0 bg-red-100">1</div>
